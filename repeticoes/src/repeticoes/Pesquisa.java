...
public class Pesquisa {
	...
	public static void main(String[] args) {
		...
		long somaIdades = 0; //long para dar mais precisão no cálculo da média 
		...
		mediaIdades = Math.round(somaIdades/totalRespostas); //round arredonda
		...
		System.out.printf("Média das idades: %.0f anos", mediaIdades);
